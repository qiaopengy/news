		...
		<div class="main-top">
			...
			<div class="login-box">
				...
				<%
					...
					if (ousername != null &&!ousername.equals("")) {
						out.print("欢迎你,"+ousername.toString());
						%>
				...
				<label>用户名</label><input type="text" name="uname"
					value="<%=username %>" /><label>密码</label><input type="text"
					name="upassword" />
				<button>登录</button>
				<% }%>
				...
				//统计该页面的访问次数，并在此显示
				 ...
				 if(count == null){
				 //第一次访问该页面时，需要创建一个存储访问次数的变量并将其放入application
				 application.setAttribute("count", 1);
				 }else{
				 //非第一次访问该页面，去application中先将记录次数变量取出，并加1，并将最新访问次数放入application中
				 Integer i = (Integer)count;
				  application.setAttribute("count", i+1);
				 }
				 Integer icount = (Integer)application.getAttribute("count");
				 out.println("访问次数："+icount);
				 %>
			...
			<div class="sl">
				<div class="sr clearfix">
					...
					<span class="left-search clearfix"> <label>站内搜索</label><input
						...
						<button class="go-btn"></button> </span> <span class="right-link">
						<label>快速链接</label><select><option>-----专题选择-----</option>
					</select>
						<button class="go-btn"></button> </span>
					...
					<div class="main-text-box-bbg">
						...
						<div class="main-text-box-content">
							<ul class="news-list-ul clearfix">
								<li><span>2016-4-28 10:33:33</span><a
									href="<%=request.getContextPath()%>/pages/newsDetail.jsp"">课工场Java
										Web，璇女神带你学习</a></li>
								<li><span>2016-4-28 10:33:33</span><a href="#">课工场UI节日回馈，送线下项目实战课程</a>
								</li>
								<li><span>2016-4-28 10:33:33</span><a href="#">利用响应式布局搭建自己的个人简介网站</a>
								</li>
								<li><span>2016-4-28 10:33:33</span><a href="#">网页设计师的福利：可视化操作无需程序</a>
								</li>
								<li class="li-line"><span>2016-4-28 10:33:33</span><a
									href="#">提交课工场Bug或者建议，送K币，礼品</a></li>

								<li><span>2016-4-28 10:33:33</span><a href="#">课工场Java
										Web，璇女神带你学习</a></li>
								<li><span>2016-4-28 10:33:33</span><a href="#">课工场UI节日回馈，送线下项目实战课程</a>
								</li>
								<li><span>2016-4-28 10:33:33</span><a href="#">利用响应式布局搭建自己的个人简介网站</a>
						...
						<div class="news-pic">
							<dl>
								<dt>
									<img src="<%=request.getContextPath()%>/images/new-1.png" />
								</dt>
								<dd>PHP从入门到放弃</dd>
							</dl>
							<dl>
								<dt>
									<img src="<%=request.getContextPath()%>/images/new-2.png" />
								</dt>
								<dd>Java Web从绝望到希望</dd>
							</dl>
							<dl>
								<dt>
									<img src="<%=request.getContextPath()%>/images/new-3.png" />
								</dt>
								<dd>课工场五一回馈</dd>
							</dl>
							<dl>
						...
						<div class="page-bar">
							...
							<span class="page-go-form"><label>跳转至</label><input
								type="text" name="numkey" class="page-key" />页
								<button type="submit" class="page-btn">GO</button> </span>
						</div>
					</div>
				</div>
			</div>
